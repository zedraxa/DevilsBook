...
class TranslationsHomeEn {
	...
	/// en: 'Welcome to Ynotes'
	String get welcome => 'Welcome to Ynotes';
...
class TranslationsSettingsEn {
	...
	/// en: 'Open Ynotes folder'
	String get openDataDir => 'Open Ynotes folder';
...
class TranslationsAppInfoEn {
	...
	/// en: 'Ynotes Copyright © 2022-$buildYear Adil Hanney This program comes with absolutely no warranty. This is free software, and you are welcome to redistribute it under certain conditions.'
	String licenseNotice({required Object buildYear}) => 'Ynotes  Copyright © 2022-${buildYear}  Adil Hanney\nThis program comes with absolutely no warranty. This is free software, and you are welcome to redistribute it under certain conditions.';
...
class TranslationsSentryConsentEn {
	...
	/// en: 'Help improve Ynotes?'
	String get title => 'Help improve Ynotes?';
...
class TranslationsSettingsPrefLabelsEn {
	...
	/// en: 'Check for Ynotes updates'
	String get shouldCheckForUpdates => 'Check for Ynotes updates';
	...
	/// en: 'Custom Ynotes folder'
	String get customDataDir => 'Custom Ynotes folder';
...
class TranslationsSettingsPrefDescriptionsEn {
	...
	/// en: '(Not recommended) Allow Ynotes to connect to servers with self-signed/untrusted certificates'
	String get allowInsecureConnections => '(Not recommended) Allow Ynotes to connect to servers with self-signed/untrusted certificates';
...
class TranslationsLoginNcLoginStepEn {
	...
	/// en: 'Ynotes' Nextcloud server'
	String get saberNcServer => 'Ynotes\' Nextcloud server';
	...
	/// en: 'Login with Ynotes'
	String get loginWithSaber => 'Login with Ynotes';
...
class TranslationsLoginEncLoginStepEn {
	...
	/// en: 'New to Ynotes? Just enter a new encryption password.'
	String get newToSaber => 'New to Ynotes? Just enter a new encryption password.';
...
class TranslationsProfile$faq$0i1$En {
	...
	/// en: 'Go to your server website and log in. Then go to Settings > Security > Change password. You'll need to log out and log back in to Ynotes after changing your password.'
	String get a => 'Go to your server website and log in. Then go to Settings > Security > Change password. You\'ll need to log out and log back in to Ynotes after changing your password.';
}
...
class TranslationsProfile$faq$0i2$En {
	...
	/// en: '0. Make sure syncing is complete (see the sync progress on the home screen). 1. Log out of Ynotes. 2. Go to your server website and delete your 'Ynotes' folder. This will delete all your notes from the server. 3. Log back in to Ynotes. You can choose a new encryption password when logging in. 4. Don't forget to log out and log back in to Ynotes on your other devices too.'
	String get a => '0. Make sure syncing is complete (see the sync progress on the home screen).\n1. Log out of Ynotes.\n2. Go to your server website and delete your \'Ynotes\' folder. This will delete all your notes from the server.\n3. Log back in to Ynotes. You can choose a new encryption password when logging in.\n4. Don\'t forget to log out and log back in to Ynotes on your other devices too.';
}
...
class TranslationsProfile$faq$0i3$En {
	...
	/// en: 'Tap on the "Delete account" button above, and login if needed. If you are using the official Ynotes server, your account will be deleted after a 1 week grace period. You can contact me at adilhanney@disroot.org during this period to cancel the deletion. If you are using a third party server, there might not be an option to delete your account: you'll need to consult the server's privacy policy for more information.'
	String get a => 'Tap on the "${_root.profile.quickLinks.deleteAccount}" button above, and login if needed.\nIf you are using the official Ynotes server, your account will be deleted after a 1 week grace period. You can contact me at adilhanney@disroot.org during this period to cancel the deletion.\nIf you are using a third party server, there might not be an option to delete your account: you\'ll need to consult the server\'s privacy policy for more information.';
}
...
class TranslationsEditorVersionTooNewEn {
	...
	/// en: 'This note was edited using a newer version of Ynotes'
	String get title => 'This note was edited using a newer version of Ynotes';
...
class TranslationsLoginNcLoginStepLoginFlowEn {
	...
	/// en: 'Please authorize Ynotes to access your Nextcloud account'
	String get pleaseAuthorize => 'Please authorize Ynotes to access your Nextcloud account';
...
class TranslationsLoginEncLoginStep$encFaq$0i1$En {
	...
	/// en: 'Choose a new encryption password and enter it above. Ynotes will generate your encryption keys from this password automatically.'
	String get a => 'Choose a new encryption password and enter it above.\nYnotes will generate your encryption keys from this password automatically.';
}
