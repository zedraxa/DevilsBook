# DevilsBook Privacy Policy

DevilsBook is an application developed by zedraxa that
facilitates the user in creating and organising handwritten notes.

This privacy policy may be updated from time to time.
You can view the latest privacy policy at
[github.com/zedraxa/DevilsBook/blob/c/privacy_policy.md](https://github.com/zedraxa/DevilsBook/blob/c/privacy_policy.md),
and you can view the history of changes to the privacy policy on
[GitHub](https://github.com/zedraxa/DevilsBook/blob/c/privacy_policy.md).
...
This is why DevilsBook encrypts your notes before uploading them to the cloud,
...
- Nextcloud is general-purpose software, so the server owner can see any other files you upload
  to the server and information you provide outside of DevilsBook.

## Third-party service: Error tracking

To help diagnose and fix errors in the application,
DevilsBook uses [Sentry](https://sentry.io), an open-source SDK, to
...
[GPLv3 license](https://github.com/zedraxa/DevilsBook/blob/c/LICENSE.md)
and is available on [GitHub](https://github.com/zedraxa/DevilsBook).

## How can I delete my data?

1. To delete the local data on your device, simply uninstall the application.
  Desktop users will also need to delete the `DevilsBook` folder inside your Documents folder.

2. To delete your account and data on the cloud:
    - If you use a Nextcloud server, there may be a "Delete account" option in the Settings.
...
This application is developed by zedraxa.
You can [create an issue](https://github.com/zedraxa/DevilsBook/issues/new/choose)
on this repo (requires a GitHub account) for any enquiries.
